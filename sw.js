...
<style>
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  h1{color:#FFD700;font-size:20px;font-weight:900;margin-bottom:10px;}
  p{color:#8294AE;font-size:14px;line-height:1.8;margin-bottom:22px;}
...
<body>
  <div class="box">
    ...
    <p>هذا التطبيق يحتاج اتصالاً فعلياً بالإنترنت ليعمل، لأن كل عملياتك (التسجيل، الإيداع، السحب، المهام...) تُحفظ مباشرة على السيرفر. تأكد من اتصالك ثم أعد المحاولة.</p>
